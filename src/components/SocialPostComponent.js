...
const SocialPostComponent = (props) => {
    ...
    const loadImage = () => {
        homeService.getSocialPostImage(props.post.socialPost.id).then(
            (response) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Image style={{width:"100%", borderRadius: "15px"}} src={URL.createObjectURL(new Blob(binaryData, { type: "image/jpeg" }))} />
            </div>
